...
type LineItem struct {
	...
	LineItemDescription  string            `csv:"lineItem/LineItemDescription" json:"lineItemDescription"`
	NormalizationFactor	 float64           `csv:"lineItem/NormalizationFactor" json:"normalizationFactor"`
